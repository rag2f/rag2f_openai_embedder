...
**Purpose**  
Normative rules for contributing to RAG2F plugin. This page explains **how** to work on the repo (style, tests, plugins, config).  
...
## Quick Facts
- **Python**: minimum 3.12  
- **Layout**: `src/` (package in `src/plugin_name/`) , `tests/`
...
requirements.txt or pyproject.toml  # plugin-specific dependencies
```
